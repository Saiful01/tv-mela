                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control" name="type" required>
                                    <option value="1" @if($result->type === "1")@endif> টিভি মেলার আদ্যোপান্ত</option>
                                    <option value="2" @if($result->type === "2")@endif> তারকাদের পছন্দ</option>
                                    <option value="3" @if($result->type === "3")@endif> শোরুম ভিজিট</option>
                                </select>
                            </div>
                        </div>
