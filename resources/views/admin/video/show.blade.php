                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control" name="type" required>
                                    <option value="1"> টিভি মেলার আদ্যোপান্ত</option>
                                    <option value="2"> তারকাদের পছন্দ</option>
                                    <option value="3"> শোরুম ভিজিট</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                        ...
                        @foreach($results as $res)
                            <tr>
                                ...
                                <td>
                                    @if($res->type == 1)
                                        <span>টিভি মেলার আদ্যোপান্ত</span>
                                    @elseif($res->type == 2)
                                        <span> তারকাদের পছন্দ</span>
                                    @else
                                        <span> শোরুম ভিজিট</span>
                                    @endif
